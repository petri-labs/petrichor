...
func (m MsgServer) Delegate(ctx context.Context, msg *types.MsgDelegate) (*types.MsgDelegateResponse, error) {
	...
	validator, err := m.Keeper.GetPetrichorValidator(sdkCtx, valAddr)
	if err != nil {
		return nil, err
	}
...
func (m MsgServer) Redelegate(ctx context.Context, msg *types.MsgRedelegate) (*types.MsgRedelegateResponse, error) {
	...
	srcValidator, err := m.Keeper.GetPetrichorValidator(sdkCtx, srcValAddr)
	if err != nil {
		return nil, err
	}

	dstValidator, err := m.Keeper.GetPetrichorValidator(sdkCtx, dstValAddr)
	if err != nil {
		return nil, err
	}
