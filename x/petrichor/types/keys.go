...
func GetPetrichorValidatorInfoKey(valAddr sdk.ValAddress) []byte {
	return append(ValidatorInfoKey, address.MustLengthPrefix(valAddr)...)
}

func ParsePetrichorValidatorKey(key []byte) sdk.ValAddress {
	b := key[2:]
	return b
}
