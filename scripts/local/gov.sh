...
printf "#1) Submit proposal to create upetrix Petrichor...\n\n"
petrichord tx gov submit-legacy-proposal create-petrichor upetrix 0.5 0.00005 1 0 --from=demowallet1 --home ./data/petrichor --keyring-backend=test --broadcast-mode=block --gas 1000000 -y > /dev/null 2>&1
