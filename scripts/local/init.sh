...
# petrichor1phaxpevm5wecex2jyaqty2a4v02qj7qm24tyvq / petrichorvaloper1phaxpevm5wecex2jyaqty2a4v02qj7qmut9cku
...
# petrichor1cyyzpxplxdzkeea7kwsydadg87357qnaznl0wd
...
PETRICHOR_CLAIM_REWARDS="5s"


# Stop if it is already running 
if pgrep -x "petrichord" >/dev/null; then
    echo "Terminating petrichord..."
    killall petrichord
fi
...
petrichord init test --home $CHAIN_DIR/$CHAINID --chain-id=$CHAINID

echo "Adding genesis accounts..."
echo $VAL_MNEMONIC_1 | petrichord keys add val1 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_1 | petrichord keys add demowallet1 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_2 | petrichord keys add demowallet2 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_3 | petrichord keys add demowallet3 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test
echo $DEMO_MNEMONIC_4 | petrichord keys add demowallet4 --home $CHAIN_DIR/$CHAINID --recover --keyring-backend=test

petrichord add-genesis-account $(petrichord --home $CHAIN_DIR/$CHAINID keys show val1 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000upetrix  --home $CHAIN_DIR/$CHAINID
petrichord add-genesis-account $(petrichord --home $CHAIN_DIR/$CHAINID keys show demowallet1 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000upetrix  --home $CHAIN_DIR/$CHAINID
petrichord add-genesis-account $(petrichord --home $CHAIN_DIR/$CHAINID keys show demowallet2 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000upetrix  --home $CHAIN_DIR/$CHAINID
petrichord add-genesis-account $(petrichord --home $CHAIN_DIR/$CHAINID keys show demowallet3 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000upetrix  --home $CHAIN_DIR/$CHAINID
petrichord add-genesis-account $(petrichord --home $CHAIN_DIR/$CHAINID keys show demowallet4 --keyring-backend test -a) 10000000000000${STAKEDENOM},10000000000000upetrix  --home $CHAIN_DIR/$CHAINID

echo "Creating and collecting gentx..."
petrichord gentx val1 7000000000${STAKEDENOM} --home $CHAIN_DIR/$CHAINID --chain-id $CHAINID --keyring-backend test
petrichord collect-gentxs --home $CHAIN_DIR/$CHAINID
...
## PETRICHOR
sed -i -e "s/\"reward_claim_interval\": \"300s\"/\"reward_claim_interval\": \"$PETRICHOR_CLAIM_REWARDS\"/g" $CHAIN_DIR/$CHAINID/config/genesis.json
sed -i -e "s/\"reward_delay_time\": \"86400s\"/\"reward_delay_time\": \"$PETRICHOR_CLAIM_REWARDS\"/g" $CHAIN_DIR/$CHAINID/config/genesis.json


echo "Genesis event created with $STAKEDENOM and upetrix"